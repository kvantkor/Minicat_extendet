...
/*
 * файл драйвера клавиатуры(часть драйвера зашита в главном файле)
 * функция обработчик клавиатуры-переводчик
*/

// таблица символов без шифта Явно задаем размер 128, чтобы избежать вылета за пределы
...
// обработчик клавиатуры-переводчик
